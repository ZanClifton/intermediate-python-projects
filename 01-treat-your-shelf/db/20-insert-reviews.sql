...
VALUES
    ...
    (1, 'Hilarious and Entertaining', 'One of the best books I''ve ever read, both sci-fi and comedy. It''s just so witty, clever, and amazing at subverting expectations in all the best ways. It''s honestly hard to put down. While the plot is simple, that doesn''t hinder the story to deliver a shockingly well developed galaxy and alien races. Highly recommend for anyone looking for a laugh.', 5),
    ...
    (11, 'I hate romance', 'Had to read this for school. It was awful and I never want to read anything like it again', 1);